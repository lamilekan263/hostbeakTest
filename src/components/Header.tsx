            ...
            <div className="flex space-x-4 items-center">
                ...
                <div className="flex justify-center items-center h-10 w-10 border-2 border-[#E9E9E9] rounded-full relative ">
                    ...
                    <svg width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.787598 14.6612H16.1688" stroke="#091E46" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M1.74854 7.9319C1.74854 4.21542 4.76134 1.20261 8.47783 1.20261V1.20261C12.1943 1.20261 15.2071 4.21541 15.2071 7.9319V14.6612H1.74854V7.9319Z" stroke="#091E46" strokeLinecap="round" strokeLinejoin="round" />
